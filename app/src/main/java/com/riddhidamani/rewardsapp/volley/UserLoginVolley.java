...
public class UserLoginVolley {

    private static final String TAG = "UserLoginVolley";
    private static final String baseURL = "http://www.christopherhield.org/api/";
    private static final String endPoint = "Profile/Login";

    public static void getLoginDetails(MainActivity mainActivity, String usernameStr, String passwordStr, String APIKey) {
